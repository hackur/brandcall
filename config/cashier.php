...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the model that will be used for billing. In BrandCall, we bill
    | tenants (organizations) rather than individual users, so we use the
    | Tenant model instead of the default User model.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Billable Model Table
    |--------------------------------------------------------------------------
    |
    | This is the database table used by the billable model for storing
    | Stripe-related information.
    |
    */
